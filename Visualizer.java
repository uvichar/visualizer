...
public class Visualizer extends JFrame implements ActionListener {
	...
	public Visualizer() throws InterruptedException {
		...
		// Panels
		mainPanel.setBackground(new Color(55, 15, 110));
		mainPanel.setBounds(0, 0, WIDTH, 230);
		mainPanel.setLayout(null);

		rectArr.setBackground(new Color(55, 15, 110));
		...
		title.setFont(new Font("Monospace", Font.BOLD, 44));

		name = new JLabel("by: Utkarsh");
		name.setForeground(Color.WHITE);
		name.setBounds(650, 100, 545, 65);
		name.setFont(new Font("Monospace", Font.BOLD, 26));
		...
		timeComplexity.setFont(new Font("Monospace", Font.BOLD, 22));
		...
		spaceComplexity.setFont(new Font("Monospace", Font.BOLD, 22));

		comparisons = new JLabel("No. of Comparisons: ");
		comparisons.setForeground(Color.WHITE);
		comparisons.setBounds(10, 95, 400, 120);
		comparisons.setFont(new Font("Monospace", Font.BOLD, 22));


		// Drop-down menu
		algorithms = new JComboBox<String>(new String[]{"Select Algo", "Bubble Sort", "Heap Sort", "Insertion Sort", "Merge Sort"});
		algorithms.setBounds(1320, 30, 200, 40);
		algorithms.setFont(new Font("Monospace", Font.BOLD, 26));

		// Buttons
		visualize = new JButton("Visualize");
		visualize.setBounds(1360, 90, 150, 40);
		visualize.setFont(new Font("Monospace", Font.BOLD, 26));

		shuffle = new JButton("Shuffle");
		shuffle.setBounds(1360, 150, 150, 40);
		shuffle.setFont(new Font("Monospace", Font.BOLD, 26));
